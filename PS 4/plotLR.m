...
for i=1:nrow
    for j=1:ncol
        ...
        fill([0:horizon-1 fliplr(0:horizon-1)]' ,[squeeze(upper_plot(i,j,:)); flipud(squeeze(lower_plot(i,j,:)))],...
        [0 0.4470 0.7410],'EdgeColor','None'); hold on;
        plot(0:horizon-1,(squeeze(irfs_plot(i,j,:))),'-','LineWidth',1.5,'Color','k'); hold on;
