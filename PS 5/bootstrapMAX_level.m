function [bootMAX, upper, lower, boot_beta] = bootstrapMAX_level(y,p,c,beta,residuals,nboot,horizon,prc)
...
for b=1:nboot
    ...
    h_est_loop = fminsearch(@(h) lr_target_level(h,chol_loop,var),startvalue,options);
