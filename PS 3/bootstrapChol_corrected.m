function [bootchol, upper, lower, boot_beta] = bootstrapChol_corrected(y,p,c,beta,residuals,nboot1,horizon,prc,cumulate,nboot2,scaling)
...
if nargin > 10
    [bootchol, upper, lower, boot_beta] = bootstrapChol(y,p,c,Beta',residuals,nboot2,horizon,prc,cumulate,scaling);
else
    [bootchol, upper, lower, boot_beta] = bootstrapChol(y,p,c,Beta',residuals,nboot2,horizon,prc,cumulate);
end
